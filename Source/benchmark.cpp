...
//
//  Created by software team in Prolific on 3/13/2017.
...
{
    bool found_PL25A1_device = false;   // TRUE means PL25A1 was found
    ...
    if (argc != 2) {
        printf("Usage:\n\t%s [send/recv]\n", argv[0]);
		// gProgRole = PROGRAM_ROLE_SENDER;   // For debug only
